...
class Precificacao:
    ...
    def __init__(self, dimensao):
        ...
        self.config['manta_revestimento'] = Database('manta_revestimento').lista()
...
#*** MÃO DE OBRA***
    ...
    def preco_mao_de_obra_construcao_dimensionado(self):
        dimensao = self.dimensao
        return self.get_preco_mao_de_obra('construcao_piscina') * dimensao.m2total()

    def preco_remocao_de_terra_dimensionado(self):
        dimensao = self.dimensao
        return self.get_preco_mao_de_obra('remocao_de_terra') * dimensao.m3total()

    def preco_construcao_calcada(self):
        dimensao = self.dimensao
        return self.get_preco_mao_de_obra('construcao_calcada') * dimensao.area_da_calcada()